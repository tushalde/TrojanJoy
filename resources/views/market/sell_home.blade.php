        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                                ...
                                <div class="form-group form-inline">
                                    <div class="row">
                                        ...
                                        <div class="col-offset-2 col-md-offset-2 col-sm-offset-2">
                                            <select class="form-control" id="sell_dept">
                                                <optgroup label="All Departments">
                                                    <option id="default">Appliances</option>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" id="clear_sell_item" class="pull-left">Clear</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal" id="cancel_sell_item">Cancel</button>
                    <button type="submit" class="btn btn-primary" id="btnSave">Save this post</button>
                </div>
            </div>
        </div>
    </div>
